...
class EDID13ValidTest(EDID13Test):
    ...
    def test_all(self):
        test_edid = b'\x00\xFF\xFF\xFF\xFF\xFF\xFF\x00\x52\x62\x06\x02\x01' \
    ...
    def test_cvt_support_definition(self):
        test_edid = [0x4D, 0xD0, 0x00, 0xA0, 0xF0, 0x70, 0x3E, 0x80, 0x30,
                     0x20, 0x35, 0x00, 0x55, 0x50, 0x21, 0x00, 0x00, 0x1A,

                     0x00, 0x00, 0x00, 0xFF, 0x00, 0x37, 0x33, 0x4B, 0x30,
                     0x32, 0x37, 0x35, 0x41, 0x43, 0x4B, 0x37, 0x4C, 0x0A,

                     0x00, 0x00, 0x00, 0xFC, 0x00, 0x44, 0x45, 0x4C, 0x4C,
                     0x20, 0x55, 0x50, 0x32, 0x37, 0x31, 0x38, 0x51, 0x0A,

                     0x00, 0x00, 0x00, 0xFD, 0x00, 0x1D, 0x56, 0x1E, 0x8C,
                     0x36, 0x01, 0x0A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20]
        data = self.parser.parse_descriptors(test_edid)
