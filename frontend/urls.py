...
urlpatterns = patterns('',
    ...
    url(r'^edid/(?P<edid_pk>\d+)/standard_timing/(?P<identification>\d+)/move_(?P<direction>up|down)/$', views.StandardTimingReorder.as_view(), name='standard-timing-reorder'),
    ...
    url(r'^edid/(?P<edid_pk>\d+)/detailed_timing/(?P<identification>\d+)/move_(?P<direction>up|down)/$', views.DetailedTimingReorder.as_view(), name='detailed-timing-reorder'),
