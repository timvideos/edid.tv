...
class EditEDIDForm(forms.ModelForm):
    class Meta:
        ...
        fields = [#Main Fields
                  ...
                  'bsp_video_input', 'bsp_signal_level_standard', 'bsp_blank_to_black_setup',
                  'bsp_separate_syncs', 'bsp_composite_sync', 'bsp_sync_on_green_video',
                  'bsp_vsync_serration', 'bsp_video_input_DFP_1', 'bsp_max_horizontal_image_size',
                  'bsp_max_vertical_image_size', 'bsp_display_gamma', 'bsp_feature_display_type',
                  'bsp_feature_standby', 'bsp_feature_suspend', 'bsp_feature_active_off',
                  'bsp_feature_standard_sRGB', 'bsp_feature_preferred_timing_mode', 'bsp_feature_default_GTF',
                  #Chromaticity
